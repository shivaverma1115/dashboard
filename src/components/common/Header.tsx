...
import ContactInfoShort from "./ContactInfoShort";
import CancelOrderShort from "./CancelOrderShort";
...
const Header = ({ breadCampTitle }: breadCampTitleType) => {
  ...
  const { toggleSideMenu, logout, totalCancelOrder } = useGlobalContext();
              ...
              <div className="cashier-header-content flex items-center justify-between custom-height-70">
                ...
                <div className="flex items-center">
                  ...
                  <div className="cashier-header-notify-wrapper px-5 flex items-center border-l border-solid border-grayBorder custom-height-70 pr-0">
                    ...
                    >
                      <Link id="emaildropdown" href="" className="emai notification-link">
                        {
                          totalCancelOrder === 0 ? <></> : <><span className="total-pending">{totalCancelOrder}</span></>
                        }
                        <NotificationIcon />
                      </Link>
                      <div

  ...
  return (
    <>
      <div className="cashier-content-area mt-[0px]">
        <div
          ref={componentRef}
          className="cashier-salereturns-area bg-white p-4 custom-shadow rounded-lg mb-5"
        >
          <h4 className="text-[24px] maxMd:text-[20px] maxMd:mb-2 font-bold text-heading mb-5">
            INVOICE
          </h4>
          <hr />
          <div className="flex justify-between maxMd:mt-3 flex-wrap mt-6">
            ...
            <div className="text-right maxMd:text-left">
              ...
              <p className="invoice-p">
                {" "}
                <span className="font-bold">PHONE</span> : {myClients?.Phone}{" "}
              </p>
            </div>
          </div>
